							...
							<form class="form-horizontal" action="<?php echo base_url().'Home/add_document'; ?>">
								<fieldset class="content-group">
			                        ...
			                        <div class="form-group">
			                        	<label class="control-label col-lg-2">Root Cause</label>
			                        	<div class="col-lg-10">
				                            <select name="select" class="form-control">
				                                <option value="opt1">Deviation</option>
				                                
				                            </select>
			                            </div>
			                        </div>
			                        <div class="form-group">
			                        	<label class="control-label col-lg-2">Corrective action</label>
			                        	<div class="col-lg-10">
				                            <select name="select" class="form-control">
			                        ...
			                        <div class="form-group">
			                        	<label class="control-label col-lg-2">Responsible</label>
			                        	<div class="col-lg-10">
				                            <select name="select" class="form-control">
				                                <option value="opt1">Engineering</option>
